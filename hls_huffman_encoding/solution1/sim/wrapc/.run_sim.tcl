...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "huffman_encoding.autotvin.dat"
	set constFileTvOut       "huffman_encoding.autotvout.dat"
	set constFileHdlTvIn     "huffman_encoding.autohdltvin.dat"
	set constFileHdlTvOut    "huffman_encoding.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
