...
if {[file isfile huffman_encoding.autotvin.dat]} {
	file delete -force huffman_encoding.autotvin.dat
}

if {[file isfile huffman_encoding.autotvout.dat]} {
	file delete -force huffman_encoding.autotvout.dat
}
