...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~(((extLd_out_out1_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1)) | ((extLd_out_out_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1)) | ((val_assign7_out_out_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1))) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln34_fu_207_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~(((extLd_out_out1_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1)) | ((extLd_out_out_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1)) | ((val_assign7_out_out_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1))) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if ((~(((extLd_out_out1_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1)) | ((extLd_out_out_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1)) | ((val_assign7_out_out_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1))) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln34_fu_207_p2 == 1'd0))) begin
        zext_ln35_reg_240[8 : 0] <= zext_ln35_fu_218_p1[8 : 0];
    end
end

always @ (*) begin
    if ((~(((extLd_out_out1_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1)) | ((extLd_out_out_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1)) | ((val_assign7_out_out_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1))) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln34_fu_207_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~(((extLd_out_out1_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1)) | ((extLd_out_out_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1)) | ((val_assign7_out_out_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1))) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln34_fu_207_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~(((extLd_out_out1_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1)) | ((extLd_out_out_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1)) | ((val_assign7_out_out_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1))) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln34_fu_207_p2 == 1'd0))) begin
...
always @ (*) begin
    ap_block_state2 = (((extLd_out_out1_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1)) | ((extLd_out_out_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1)) | ((val_assign7_out_out_full_n == 1'b0) & (icmp_ln34_fu_207_p2 == 1'd1)));
end
