...
entity Block_huffman_encodi is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Block_huffman_encodi is 
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif ((not(((ap_start = ap_const_logic_0) or (n_out_full_n = ap_const_logic_0) or (n_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, n_empty_n, n_out_full_n)
    begin
        case ap_CS_fsm is
    ...
    begin
                ap_block_state1 <= ((ap_start = ap_const_logic_0) or (n_out_full_n = ap_const_logic_0) or (n_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;


    ap_done_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, n_empty_n, n_out_full_n)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (n_out_full_n = ap_const_logic_0) or (n_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    ap_ready_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, n_empty_n, n_out_full_n)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (n_out_full_n = ap_const_logic_0) or (n_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    ap_return_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, n_dout, n_empty_n, n_out_full_n, ap_return_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (n_out_full_n = ap_const_logic_0) or (n_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return <= n_dout;
        else 
