...
void huffman_encoding_DeQ::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void huffman_encoding_DeQ::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void huffman_encoding_DeQ::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void huffman_encoding_DeQ::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
