...
const sc_logic Block_huffman_encodi::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic Block_huffman_encodi::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<1> Block_huffman_encodi::ap_ST_fsm_state1 = "1";
const sc_lv<32> Block_huffman_encodi::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_lv<9> Block_huffman_encodi::ap_const_lv9_0 = "000000000";
const bool Block_huffman_encodi::ap_const_boolean_1 = true;

Block_huffman_encodi::Block_huffman_encodi(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    apTFilenSS << "Block_huffman_encodi_sc_trace_" << apTFileNum ++;
...
Block_huffman_encodi::~Block_huffman_encodi() {
    if (mVcdFile) 
        sc_close_vcd_trace_file(mVcdFile);

}

void Block_huffman_encodi::thread_ap_clk_no_reset_() {
...
void Block_huffman_encodi::thread_ap_CS_fsm_state1() {
    ap_CS_fsm_state1 = ap_CS_fsm.read()[0];
}

void Block_huffman_encodi::thread_ap_block_state1() {
...
void Block_huffman_encodi::thread_ap_done() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, n_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, n_out_full_n.read())))) {
...
void Block_huffman_encodi::thread_ap_idle() {
...
void Block_huffman_encodi::thread_ap_ready() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, n_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, n_out_full_n.read())))) {
...
void Block_huffman_encodi::thread_ap_return() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, n_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, n_out_full_n.read())))) {
...
void Block_huffman_encodi::thread_n_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
...
void Block_huffman_encodi::thread_n_out_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
...
void Block_huffman_encodi::thread_n_out_din() {
    n_out_din = n_dout.read();
}

void Block_huffman_encodi::thread_n_out_write() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, n_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, n_out_full_n.read())))) {
...
void Block_huffman_encodi::thread_n_read() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, n_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, n_out_full_n.read())))) {
...
void Block_huffman_encodi::thread_ap_NS_fsm() {
