...
struct compute_bit_length : public sc_module {
    ...
    sc_signal< sc_lv<9> > p_012_0_i_i_reg_283;
    sc_signal< sc_lv<9> > parent_curr_V_1_reg_292;
    sc_signal< sc_lv<9> > p_010_0_i_i_reg_303;
    sc_signal< sc_lv<9> > left_curr_V_1_reg_312;
    sc_signal< sc_lv<9> > p_08_0_i_i_reg_323;
    sc_signal< sc_lv<9> > right_curr_V_1_reg_332;
    sc_signal< sc_lv<32> > i2_0_i_i_reg_343;
    sc_signal< sc_lv<10> > zext_ln13_fu_366_p1;
    sc_signal< sc_lv<10> > zext_ln13_reg_492;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<7> > i_5_fu_376_p2;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<10> > add_ln23_fu_388_p2;
    sc_signal< sc_lv<10> > add_ln23_reg_507;
    sc_signal< sc_logic > ap_CS_fsm_state3;
    sc_signal< sc_lv<10> > i_fu_393_p2;
    sc_signal< sc_lv<10> > i_reg_512;
    sc_signal< sc_lv<10> > add_ln26_fu_398_p2;
    sc_signal< sc_lv<10> > add_ln26_reg_518;
    sc_signal< sc_logic > ap_CS_fsm_state4;
    sc_signal< sc_lv<9> > parent_curr_V_reg_553;
    sc_signal< sc_logic > ap_CS_fsm_state5;
    sc_signal< sc_lv<9> > parent_next_V_reg_558;
    sc_signal< sc_lv<9> > left_curr_V_reg_563;
    sc_signal< sc_lv<9> > left_next_V_reg_568;
    sc_signal< sc_lv<9> > right_curr_V_reg_573;
    sc_signal< sc_lv<9> > right_next_V_reg_578;
    sc_signal< sc_lv<32> > sext_ln25_1_fu_419_p1;
    sc_signal< sc_logic > ap_CS_fsm_state6;
    sc_signal< sc_lv<1> > tmp_fu_422_p3;
    sc_signal< sc_lv<1> > tmp_reg_588;
    sc_signal< sc_logic > ap_CS_fsm_pp1_stage0;
    sc_signal< bool > ap_block_state7_pp1_stage0_iter0;
    sc_signal< bool > ap_block_state10_pp1_stage0_iter1;
    sc_signal< bool > ap_block_pp1_stage0_11001;
    sc_signal< sc_lv<1> > icmp_ln883_fu_435_p2;
    sc_signal< sc_lv<1> > icmp_ln883_reg_597;
    sc_signal< sc_lv<1> > icmp_ln883_reg_597_pp1_iter1_reg;
    sc_signal< sc_lv<1> > icmp_ln883_1_fu_441_p2;
    sc_signal< sc_lv<1> > icmp_ln883_1_reg_601;
    sc_signal< sc_lv<1> > icmp_ln883_1_reg_601_pp1_iter1_reg;
    sc_signal< sc_lv<32> > add_ln57_fu_447_p2;
    sc_signal< sc_lv<32> > add_ln57_reg_605;
    sc_signal< sc_lv<6> > child_depth_V_q0;
    sc_signal< sc_lv<6> > child_depth_V_load_reg_610;
    sc_signal< sc_logic > ap_CS_fsm_pp1_stage1;
    sc_signal< sc_logic > ap_enable_reg_pp1_iter0;
    sc_signal< bool > ap_block_state8_pp1_stage1_iter0;
    sc_signal< bool > ap_block_state11_pp1_stage1_iter1;
    sc_signal< bool > ap_block_pp1_stage1_11001;
    sc_signal< sc_lv<64> > zext_ln544_6_fu_470_p1;
    sc_signal< sc_lv<64> > zext_ln544_6_reg_630;
    sc_signal< sc_logic > ap_CS_fsm_pp1_stage2;
    sc_signal< bool > ap_block_state9_pp1_stage2_iter0;
    sc_signal< bool > ap_block_pp1_stage2_11001;
    sc_signal< sc_lv<6> > internal_length_hist_2_reg_635;
    sc_signal< sc_lv<9> > parent_next_V_1_reg_640;
    sc_signal< sc_lv<9> > left_next_V_1_reg_645;
    sc_signal< sc_lv<9> > right_next_V_1_reg_650;
    sc_signal< sc_lv<32> > i_6_fu_475_p2;
    sc_signal< sc_lv<32> > i_6_reg_655;
    sc_signal< sc_lv<9> > internal_length_hist_q0;
    sc_signal< sc_lv<9> > count_V_reg_660;
    ...
    sc_signal< sc_lv<7> > i_0_i_i_reg_272;
    sc_signal< sc_lv<1> > icmp_ln17_fu_370_p2;
    sc_signal< sc_lv<9> > ap_phi_mux_p_012_0_i_i_phi_fu_286_p4;
    sc_signal< bool > ap_block_pp1_stage0;
    sc_signal< sc_lv<9> > ap_phi_mux_p_010_0_i_i_phi_fu_306_p4;
    sc_signal< sc_lv<9> > ap_phi_mux_p_08_0_i_i_phi_fu_326_p4;
    sc_signal< sc_lv<32> > ap_phi_mux_i2_0_i_i_phi_fu_346_p4;
    sc_signal< sc_lv<2> > ap_phi_reg_pp1_iter0_phi_ln700_i_i_reg_353;
    sc_signal< sc_lv<2> > ap_phi_reg_pp1_iter1_phi_ln700_i_i_reg_353;
    sc_signal< sc_lv<64> > zext_ln19_fu_382_p1;
    sc_signal< sc_lv<64> > sext_ln23_fu_403_p1;
    sc_signal< sc_lv<64> > sext_ln25_fu_407_p1;
    sc_signal< sc_lv<64> > sext_ln26_fu_413_p1;
    sc_signal< sc_lv<64> > zext_ln544_fu_430_p1;
    sc_signal< sc_lv<64> > sext_ln57_fu_453_p1;
    sc_signal< bool > ap_block_pp1_stage1;
    sc_signal< sc_lv<64> > zext_ln37_fu_465_p1;
    sc_signal< bool > ap_block_pp1_stage2;
    sc_signal< sc_lv<9> > count_V_1_fu_485_p2;
    sc_signal< sc_lv<6> > length_V_fu_459_p2;
    sc_signal< sc_lv<9> > zext_ln544_5_fu_481_p1;
    ...
    void thread_add_ln23_fu_388_p2();
    void thread_add_ln26_fu_398_p2();
    void thread_add_ln57_fu_447_p2();
    ...
    void thread_ap_phi_mux_i2_0_i_i_phi_fu_346_p4();
    void thread_ap_phi_mux_p_010_0_i_i_phi_fu_306_p4();
    void thread_ap_phi_mux_p_012_0_i_i_phi_fu_286_p4();
    void thread_ap_phi_mux_p_08_0_i_i_phi_fu_326_p4();
    void thread_ap_phi_reg_pp1_iter0_phi_ln700_i_i_reg_353();
    ...
    void thread_count_V_1_fu_485_p2();
    void thread_extLd_loc_blk_n();
    void thread_extLd_loc_read();
    void thread_i_5_fu_376_p2();
    void thread_i_6_fu_475_p2();
    void thread_i_fu_393_p2();
    void thread_icmp_ln17_fu_370_p2();
    void thread_icmp_ln883_1_fu_441_p2();
    void thread_icmp_ln883_fu_435_p2();
    ...
    void thread_length_V_fu_459_p2();
    ...
    void thread_sext_ln23_fu_403_p1();
    void thread_sext_ln25_1_fu_419_p1();
    void thread_sext_ln25_fu_407_p1();
    void thread_sext_ln26_fu_413_p1();
    void thread_sext_ln57_fu_453_p1();
    void thread_tmp_fu_422_p3();
    void thread_zext_ln13_fu_366_p1();
    void thread_zext_ln19_fu_382_p1();
    void thread_zext_ln37_fu_465_p1();
    void thread_zext_ln544_5_fu_481_p1();
    void thread_zext_ln544_6_fu_470_p1();
    void thread_zext_ln544_fu_430_p1();
