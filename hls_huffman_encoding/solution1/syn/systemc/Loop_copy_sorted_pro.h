...
struct Loop_copy_sorted_pro : public sc_module {
    ...
    sc_out< sc_lv<9> > sorted_copy1_value_V_d0;
    ...
    sc_signal< sc_lv<1> > icmp_ln29_fu_191_p2;
    sc_signal< sc_logic > extLd_out_out_blk_n;
    sc_signal< sc_logic > extLd_out_out1_blk_n;
    sc_signal< sc_lv<9> > n_read_reg_208;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<9> > i_fu_196_p2;
    sc_signal< sc_lv<9> > i_reg_219;
    sc_signal< bool > ap_block_state2;
    sc_signal< sc_lv<64> > zext_ln30_fu_202_p1;
    sc_signal< sc_lv<64> > zext_ln30_reg_224;
    sc_signal< sc_lv<9> > sorted_0_load_reg_241;
    sc_signal< sc_logic > ap_CS_fsm_state3;
    sc_signal< sc_lv<32> > previous_frequency_reg_247;
    sc_signal< sc_lv<9> > i_0_i_reg_180;
    ...
    void thread_icmp_ln29_fu_191_p2();
    ...
    void thread_zext_ln30_fu_202_p1();
