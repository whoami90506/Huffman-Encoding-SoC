...
struct Loop_copy_sorted_pro : public sc_module {
    ...
    sc_out< sc_lv<9> > val_assign5_out_out_din;
    sc_in< sc_logic > val_assign5_out_out_full_n;
    sc_out< sc_logic > val_assign5_out_out_write;
    ...
    sc_signal< sc_logic > val_assign5_out_out_blk_n;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<1> > icmp_ln34_fu_207_p2;
    sc_signal< sc_logic > extLd_out_out_blk_n;
    sc_signal< sc_logic > extLd_out_out1_blk_n;
    sc_signal< sc_lv<9> > n_read_reg_224;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<9> > i_fu_212_p2;
    sc_signal< sc_lv<9> > i_reg_235;
    sc_signal< bool > ap_block_state2;
    sc_signal< sc_lv<64> > zext_ln35_fu_218_p1;
    sc_signal< sc_lv<64> > zext_ln35_reg_240;
    sc_signal< sc_lv<9> > sorted_0_load_reg_255;
    sc_signal< sc_logic > ap_CS_fsm_state3;
    sc_signal< sc_lv<32> > previous_frequency_reg_261;
    sc_signal< sc_lv<9> > i_0_i_reg_196;
    ...
    void thread_icmp_ln34_fu_207_p2();
    ...
    void thread_val_assign5_out_out_blk_n();
    void thread_val_assign5_out_out_din();
    void thread_val_assign5_out_out_write();
    void thread_zext_ln35_fu_218_p1();
