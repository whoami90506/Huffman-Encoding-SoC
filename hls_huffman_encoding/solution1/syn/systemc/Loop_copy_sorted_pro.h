...
struct Loop_copy_sorted_pro : public sc_module {
    ...
    sc_out< sc_lv<9> > val_assign6_out_out_din;
    sc_in< sc_logic > val_assign6_out_out_full_n;
    sc_out< sc_logic > val_assign6_out_out_write;
    ...
    sc_signal< sc_logic > val_assign6_out_out_blk_n;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<1> > icmp_ln40_fu_148_p2;
    sc_signal< sc_logic > extLd_out_out_blk_n;
    sc_signal< sc_logic > extLd_out_out1_blk_n;
    sc_signal< sc_lv<9> > n_read_reg_165;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<9> > i_fu_153_p2;
    sc_signal< sc_lv<9> > i_reg_176;
    sc_signal< bool > ap_block_state2;
    sc_signal< sc_lv<64> > zext_ln41_fu_159_p1;
    sc_signal< sc_lv<64> > zext_ln41_reg_181;
    sc_signal< sc_lv<9> > i12_0_i_reg_137;
    ...
    void thread_icmp_ln40_fu_148_p2();
    ...
    void thread_val_assign6_out_out_blk_n();
    void thread_val_assign6_out_out_din();
    void thread_val_assign6_out_out_write();
    void thread_zext_ln41_fu_159_p1();
