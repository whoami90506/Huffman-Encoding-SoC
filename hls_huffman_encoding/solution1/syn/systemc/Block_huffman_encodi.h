...
#ifndef _Block_huffman_encodi_HH_
#define _Block_huffman_encodi_HH_
...
struct Block_huffman_encodi : public sc_module {
    ...
    // Module declarations
    Block_huffman_encodi(sc_module_name name);
    SC_HAS_PROCESS(Block_huffman_encodi);
