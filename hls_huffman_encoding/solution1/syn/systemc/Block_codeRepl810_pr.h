...
#ifndef _Block_codeRepl810_pr_HH_
#define _Block_codeRepl810_pr_HH_
...
struct Block_codeRepl810_pr : public sc_module {
    ...
    // Module declarations
    Block_codeRepl810_pr(sc_module_name name);
    SC_HAS_PROCESS(Block_codeRepl810_pr);
