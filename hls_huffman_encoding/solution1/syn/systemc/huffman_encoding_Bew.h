...
#ifndef _huffman_encoding_Bew_H_
#define _huffman_encoding_Bew_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "huffman_encoding_Bew_memcore.h"

SC_MODULE(huffman_encoding_Bew) {
...
public:
    ...
    SC_CTOR(huffman_encoding_Bew) : m_trace_file(0) {
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "huffman_encoding_Bew.trace");
            // ports
