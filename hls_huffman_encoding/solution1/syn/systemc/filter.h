...
struct filter : public sc_module {
    ...
    sc_signal< sc_lv<9> > i_0_i_reg_113;
    sc_signal< sc_lv<1> > icmp_ln11_fu_133_p2;
    ...
    sc_signal< sc_lv<64> > zext_ln13_fu_145_p1;
    sc_signal< sc_lv<64> > zext_ln13_reg_187;
    sc_signal< sc_lv<64> > zext_ln13_reg_187_pp0_iter1_reg;
    sc_signal< sc_lv<32> > in_frequency_V_load_reg_197;
    sc_signal< sc_lv<1> > icmp_ln883_fu_150_p2;
    sc_signal< sc_lv<1> > icmp_ln883_reg_203;
    sc_signal< sc_lv<1> > icmp_ln883_reg_203_pp0_iter3_reg;
    sc_signal< sc_lv<64> > zext_ln544_fu_155_p1;
    sc_signal< sc_lv<64> > zext_ln544_reg_207;
    sc_signal< sc_lv<64> > zext_ln544_reg_207_pp0_iter3_reg;
    sc_signal< sc_lv<9> > in_value_V_load_reg_217;
    ...
    sc_signal< sc_lv<9> > t_V_fu_50;
    sc_signal< sc_lv<9> > j_V_fu_160_p2;
    ...
    void thread_icmp_ln11_fu_133_p2();
    ...
    void thread_zext_ln13_fu_145_p1();
