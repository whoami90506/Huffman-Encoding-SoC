...
struct filter : public sc_module {
    ...
    sc_signal< sc_lv<1> > icmp_ln11_fu_137_p2;
    ...
    sc_signal< sc_lv<64> > zext_ln13_fu_149_p1;
    sc_signal< sc_lv<64> > zext_ln13_reg_191;
    sc_signal< sc_lv<64> > zext_ln13_reg_191_pp0_iter1_reg;
    sc_signal< sc_lv<32> > in_frequency_V_load_reg_201;
    sc_signal< sc_lv<1> > icmp_ln883_fu_154_p2;
    sc_signal< sc_lv<1> > icmp_ln883_reg_207;
    sc_signal< sc_lv<1> > icmp_ln883_reg_207_pp0_iter3_reg;
    sc_signal< sc_lv<64> > zext_ln544_fu_159_p1;
    sc_signal< sc_lv<64> > zext_ln544_reg_211;
    sc_signal< sc_lv<64> > zext_ln544_reg_211_pp0_iter3_reg;
    sc_signal< sc_lv<10> > in_value_V_load_reg_221;
    ...
    void thread_icmp_ln11_fu_137_p2();
    ...
    void thread_zext_ln544_fu_159_p1();
