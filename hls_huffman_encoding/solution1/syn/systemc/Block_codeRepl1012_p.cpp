...
const sc_logic Block_codeRepl1012_p::ap_const_logic_1 = sc_dt::Log_1;
...
Block_codeRepl1012_p::~Block_codeRepl1012_p() {
    if (mVcdFile) 
        sc_close_vcd_trace_file(mVcdFile);

}

void Block_codeRepl1012_p::thread_ap_clk_no_reset_() {
...
void Block_codeRepl1012_p::thread_ap_CS_fsm_state1() {
    ap_CS_fsm_state1 = ap_CS_fsm.read()[0];
}

void Block_codeRepl1012_p::thread_ap_block_state1() {
...
void Block_codeRepl1012_p::thread_ap_done() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, n_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, n_out_full_n.read())))) {
...
void Block_codeRepl1012_p::thread_ap_idle() {
...
void Block_codeRepl1012_p::thread_ap_ready() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, n_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, n_out_full_n.read())))) {
...
void Block_codeRepl1012_p::thread_ap_return() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, n_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, n_out_full_n.read())))) {
...
void Block_codeRepl1012_p::thread_n_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
...
void Block_codeRepl1012_p::thread_n_out_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
...
void Block_codeRepl1012_p::thread_n_out_din() {
    n_out_din = n_dout.read();
}

void Block_codeRepl1012_p::thread_n_out_write() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, n_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, n_out_full_n.read())))) {
...
void Block_codeRepl1012_p::thread_n_read() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, n_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, n_out_full_n.read())))) {
...
void Block_codeRepl1012_p::thread_ap_NS_fsm() {
