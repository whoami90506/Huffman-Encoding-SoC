...
void huffman_encoding_Bew::proc_i_full_n() {
    i_full_n.write(full_n.read());
}

void huffman_encoding_Bew::proc_t_empty_n() {
...
void huffman_encoding_Bew::proc_pop_buf() {
...
void huffman_encoding_Bew::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void huffman_encoding_Bew::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void huffman_encoding_Bew::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
