    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    !((esl_seteq<1,1,1>(icmp_ln34_fu_145_p2.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(ap_const_logic_0, val_assign5_out_out_full_n.read())) || (esl_seteq<1,1,1>(icmp_ln34_fu_145_p2.read(), ap_const_lv1_1) && 
...
void Loop_copy_sorted_pro::thread_val_assign5_out_out_din() {
    val_assign5_out_out_din = n_read_reg_162.read();
}
