...
set Library     "hls"
set IPName      "huffman_encoding"
set Version     "1.0"
set DisplayName "Huffman_encoding"
set Revision    "2011190307"
...
set sdx_kernel_name "huffman_encoding"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "D:/Workspace/huffman_encoding_fpga/hls_huffman_encoding/solution1"
...
## Variables
set Top "huffman_encoding"
set TopNoPrefix "huffman_encoding"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS symbol_histogram_value_V symbol_histogram_frequency_V encoding_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    symbol_histogram_value_V {
        type "axi4stream"
        mode "slave"
        port_prefix "symbol_histogram_value_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    symbol_histogram_frequency_V {
        type "axi4stream"
        mode "slave"
        port_prefix "symbol_histogram_frequency_V"
        has_tready "1"
        ports {
            TDATA 32
        }
